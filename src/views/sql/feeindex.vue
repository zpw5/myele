  ...
  agg_type_change(){
    ...
    drawLine() {
      ...
      sqlquery(params1).then((response) => {
        ...
        this.chart_option.xAxis.data=jsontoarray(response.data.data,"element_id","feeindex","series_id","本年","t_xAxis");
        this.chart_option.series[0].data=[];
        this.chart_option.series[0].data=jsontoarray(response.data.data,"element_id","feeindex","series_id","本年","t_value");
        this.chart_option.series[1].data=[];
        this.chart_option.series[1].data=jsontoarray(response.data.data,"element_id","feeindex","series_id","去年","t_value");
      // 绘制图表
